...
export const Email = {
  label: 'Email',
  description: 'e.borisaxel@gmail.com',
...
export const GitHub = {
  label: 'GitHub',
  description: 'https://github.com/Meindonsa',
...
export const LinkedIn = {
  label: 'LinkedIn',
  description: 'https://linkedin.com/in/borisaxel',
...
export const Twitter = {
  label: 'Twitter/X',
  description: 'https://twitter.com/meindonsa',
...
export const Website = {
  ...
  description: 'meindonsa.vercel.app',
...
export const socialNetworks: SocialNetwork[] = [Email, GitHub, LinkedIn]
export const contactSocialNetworks: SocialNetwork[] = [Email, GitHub, LinkedIn, Website]
