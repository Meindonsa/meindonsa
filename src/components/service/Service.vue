...
import { type Service, Services } from '@/components/service/Services.ts'

const services: Ref<Service[]> = ref(Services)
</script>
    ...
    <div class="max-w-[1200px] mx-auto px-10">
      ...
      >
        ...
        >
          ...
          <p class="text-[.85rem] text-muted leading-[1.7]">{{ srv.description }}</p>
        </div>
      </div>
    </div>
  </section>
